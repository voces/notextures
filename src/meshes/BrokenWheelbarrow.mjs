...
import { box, cylinder, randColor, nudge } from "./util/deprecatedShared.mjs";
...
export default class BrokenWheelbarrow extends Mesh {
	...
	constructor( {
		...
		// Left and ride sides
		geometry.merge( plank().rotateY( Math.PI / 2 )
		...
		geometry.merge( plank( 0, false ).rotateY( Math.PI / 2 )
			.rotateZ( Math.PI / 2 )
			.translate( 0, 1 / 2, 0 ) );
		geometry.merge( plank( 0, false ).rotateY( Math.PI / 2 )
			.rotateZ( Math.PI / 2 )
		...
		back.merge( plank( 0, false ).rotateY( Math.PI / 2 )
			.rotateZ( Math.PI / 2 )
			.translate( 0, - 1 / 2, 0 ) );
		back.merge( plank( 0, false ).rotateY( Math.PI / 2 )
			.rotateZ( Math.PI / 2 )
